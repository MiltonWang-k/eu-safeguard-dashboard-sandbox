...
const flag=n=>flagMap[n]?`<img class="flag" src="https://flagcdn.com/${flagMap[n]}.svg" width="24" height="18" alt="${esc(n)} flag" style="display:inline-block;vertical-align:-3px;margin-right:6px;border-radius:2px">`:'';
